...
# y_at_length = [-2., 2.5]
# y_at_0 = [2., -2.8]
yprime_at_0 = [-5.64100643, 3.95933075]  # for fake alpha
y_at_length = [-0.5, 1.8]
y_at_0 = [2., -2.2]
# yprime_at_0 = [-50.64100643, 30.95933075]
...
mu_sparse, cov_sparse = gp_predict_sparse_LTA(xy, z, mean_func, q_mu, q_sqrt,
                                              kernel)
