...
def process_trial(vicon_data, tello_data, trial, start_idx):
    ...
    dx, dy = calc_error(x_vicon[idx], y_vicon[idx], dx_tello, dy_tello)
...
def calc_tello_traj(tello_data, rz_vicon_at_test_points, startp):
    ...
    return x_tello, y_tello, dx_tello, dy_tello


def calc_error(x_vicon_at_test_points, y_vicon_at_test_points, dx_tello,
               dy_tello):
...
def plot_vicon_with_quiver(p_data):
    plt.plot(p_data['x_vicon'], p_data['y_vicon'])
